...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const helpTexts = {
    ...
    'transfers.html': `Review transfers detected between accounts and those flagged in uploads. Mark individual items or use the Assist button to auto-match opposite payments so they are ignored in reports. Accurate transfers keep your totals honest and stop the same money being counted twice.`,
