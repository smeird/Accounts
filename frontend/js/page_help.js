...
const init = () => {
  ...
  const helpTexts = {
    ...
    'tag_taxonomy_cutover.html': `Apply a fully reviewed tag taxonomy through a separate, atomic cutover. The page verifies the immutable snapshot, protects transfers and exclusions, keeps deferred and newer transactions untouched, distinguishes incoming from outgoing rules, reconciles financial totals, and retains an audited rollback path.`,
