...
const init = () => {
  ...
  const helpTexts = {
    ...
    'account.html': `Drill into a single account to review its balance trend and transaction statement. Click any row to edit a transaction and ensure your records match the bank.`,
