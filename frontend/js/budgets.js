(function () {
    ...
    function renderBudgets(data) {
        ...
        ordered.forEach(budget => {
            ...
            const figures = document.createElement('div'); figures.className = 'budget-row__figures'; const spent = document.createElement('strong'); spent.textContent = preciseMoney(budget.spent); const plan = document.createElement('span'); plan.textContent = `of ${preciseMoney(budget.amount)}`; figures.append(spent, plan); top.append(nameBlock, figures);
