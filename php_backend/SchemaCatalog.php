    ...
    public static function tables(): array {
        return [
            ...
            'tags' => self::table([
                ...
                'description' => self::column('TEXT DEFAULT NULL', 'text', true, true),
                'origin' => self::column("VARCHAR(6) NOT NULL DEFAULT 'legacy' CHECK (origin IN ('system','manual','ai','legacy'))", 'varchar', false, true, 6),
                'status' => self::column("VARCHAR(10) NOT NULL DEFAULT 'active' CHECK (status IN ('proposed','active','deprecated','merged'))", 'varchar', false, true, 10),
            ...
            'tag_aliases' => self::table([
                ...
                'match_type' => self::column("VARCHAR(8) NOT NULL DEFAULT 'contains' CHECK (match_type IN ('exact','contains'))", 'varchar', false, true, 8),
                'direction' => self::column("VARCHAR(8) NOT NULL DEFAULT 'any' CHECK (direction IN ('any','outgoing','incoming'))", 'varchar', false, true, 8),
            ...
            'tag_migration_runs' => self::table([
                ...
                'status' => self::column("VARCHAR(11) NOT NULL DEFAULT 'snapshot' CHECK (status IN ('snapshot','staging','ready','applied','rolled_back','cancelled'))", 'varchar', false, true, 11),
            ...
            'transaction_classification_snapshots' => self::table([
                ...
                'protection_reason' => self::column("VARCHAR(8) DEFAULT NULL CHECK (protection_reason IN ('transfer','ignored'))", 'varchar', true, true, 8),
                'created_at' => self::column('TIMESTAMP DEFAULT CURRENT_TIMESTAMP', 'timestamp', null, true),
            ...
            'tag_taxonomy_proposals' => self::table([
                ...
                'status' => self::column("VARCHAR(8) NOT NULL DEFAULT 'pending' CHECK (status IN ('pending','approved','rejected'))", 'varchar', false, true, 8),
                'origin' => self::column("VARCHAR(6) NOT NULL DEFAULT 'ai' CHECK (origin IN ('ai','manual'))", 'varchar', false, true, 6),
            ...
            'tag_taxonomy_patterns' => self::table([
                ...
                'direction' => self::column("VARCHAR(8) NOT NULL CHECK (direction IN ('outgoing','incoming'))", 'varchar', false, false, 8),
                ...
                'confidence' => self::column('DECIMAL(5,4) DEFAULT NULL', 'decimal', true, true, null, null, 5, 4),
                'rationale' => self::column('VARCHAR(500) DEFAULT NULL', 'varchar', true, true, 500),
                'status' => self::column("VARCHAR(8) NOT NULL DEFAULT 'pending' CHECK (status IN ('pending','proposed','excluded'))", 'varchar', false, true, 8),
                'created_at' => self::column('TIMESTAMP DEFAULT CURRENT_TIMESTAMP', 'timestamp', null, true),
                'updated_at' => self::column('TIMESTAMP DEFAULT CURRENT_TIMESTAMP', 'timestamp', null, true, null, null),
            ], ['id'], [
