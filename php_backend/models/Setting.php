...
class Setting {
    ...
    public static function set(string $name, string $value): void {
        ...
        $sql = $driver === 'sqlite' || $driver === 'pgsql'
    ...
    public static function colorPalettes(): array {
        return [
            ...
            'skyline' => ['label' => 'Skyline', 'description' => 'Crisp blue with extra depth', 'primary' => '#0369a1', 'secondary' => '#075985'],
            'cobalt' => ['label' => 'Cobalt', 'description' => 'Strong and technically precise', 'primary' => '#1d4ed8', 'secondary' => '#1e3a8a'],
            'nordic' => ['label' => 'Nordic', 'description' => 'Cool blue flowing into teal', 'primary' => '#0369a1', 'secondary' => '#0f766e'],
            ...
            'monochrome' => ['label' => 'Monochrome', 'description' => 'Clean charcoal and ink', 'primary' => '#374151', 'secondary' => '#111827'],
            'petrol' => ['label' => 'Petrol', 'description' => 'Deep blue-green confidence', 'primary' => '#0f766e', 'secondary' => '#134e4a'],
            'jade' => ['label' => 'Jade', 'description' => 'Rich and quietly optimistic', 'primary' => '#047857', 'secondary' => '#064e3b'],
            'sage' => ['label' => 'Sage', 'description' => 'Natural and understated', 'primary' => '#4d7c0f', 'secondary' => '#365314'],
            'olive' => ['label' => 'Olive', 'description' => 'Earthy and established', 'primary' => '#657c16', 'secondary' => '#3f6212'],
            ...
            'aubergine' => ['label' => 'Aubergine', 'description' => 'Deep, formal and distinctive', 'primary' => '#6b21a8', 'secondary' => '#3b0764'],
            'mulberry' => ['label' => 'Mulberry', 'description' => 'Warm purple with depth', 'primary' => '#86198f', 'secondary' => '#581c87'],
            ...
            'cherry' => ['label' => 'Cherry', 'description' => 'Polished and assured', 'primary' => '#be123c', 'secondary' => '#881337'],
            'wine' => ['label' => 'Wine', 'description' => 'Mature red flowing into plum', 'primary' => '#9f1239', 'secondary' => '#581c87'],
            ...
            'bronze' => ['label' => 'Bronze', 'description' => 'Traditional and substantial', 'primary' => '#a16207', 'secondary' => '#713f12'],
            'copper' => ['label' => 'Copper', 'description' => 'Warm, crafted character', 'primary' => '#c2410c', 'secondary' => '#7c2d12'],
            'terracotta' => ['label' => 'Terracotta', 'description' => 'Burnt orange flowing into red', 'primary' => '#b45309', 'secondary' => '#9f1239'],
